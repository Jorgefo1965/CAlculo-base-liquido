...
// Carga asíncrona con Timeout de 2.5s para no congelar la UI
async function cargarIndicadores() {
  ...
  try {
    ...
    document.getElementById('indicadores').innerText = `Valores al día: UF $${indicadoresGlobales.uf.toLocaleString('es-CL')} | UTM $${indicadoresGlobales.utm.toLocaleString('es-CL')}`;
  } catch (e) {
    clearTimeout(timeoutId);
